...
const usersImages = ["./img/hum/g.png","./img/hum/10.png","./img/hum/11.png","./img/hum/05.png","./img/hum/07.png","./img/hum/06.png","./img/hum/08.png","./img/hum/09.png","./img/hum/03.png","./img/hum/c.png","./img/hum/g.png","./img/hum/dd.png","./img/hum/042.png","./img/hum/b.png"]
const iaImages = ["./img/rob/01.png","./img/rob/06.png","./img/rob/03.png","./img/rob/04.png","./img/rob/05.png","./img/rob/02.png","./img/rob/07.png","./img/rob/08.png", "./img/rob/08.png","./img/rob/01.png","./img/rob/06.png","./img/rob/03.png","./img/rob/04.png","./img/rob/06.png"]
var index = 0;
